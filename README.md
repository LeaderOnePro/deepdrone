...
|----------|--------|----------|-------------|
| **OpenAI** | GPT-5.4, GPT-5.2, GPT-5-mini, GPT-5-nano | Cloud | Latest GPT-5.4 and GPT-5.2 series models |
...
| **Ollama** | Qwen3.5:4B, Qwen3.5:Latest, Qwen3.5:35B, GLM-4.7-Flash, etc | Local/Network | Local & remote server support |
